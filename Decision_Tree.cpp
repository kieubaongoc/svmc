...
void read_input() {
	cout << "Thoi tiet, Nhiet do, Gio, Do am: \n";
	cin >> weather >> temp >> wind >> hud;
}
void solve() {
	if (strcmp(weather,"nang")) {
		if (strcmp(temp, "nong")) {
			cout << "=> Khong di choi";
		}else if(strcmp(temp, "mat")) {
			cout << "=> Co di choi";
		}
		else if (strcmp(temp, "lanh")) {
			cout << "=> Co di choi";
		}
	}
	else if (strcmp(weather, "mua")) {
		if (strcmp(temp, "lanh")) {
			cout << "=> Khong di choi";
		}
		else if (strcmp(temp, "mat")) {
	...
	else if (strcmp(weather, "nhieu may")) {
		cout << "=> Co di choi";
	}
}
